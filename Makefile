...
bin/yuan_spl_bootable.bin: bin/yuan_spl.bin tools/mksunxiboot
	./tools/mksunxiboot bin/yuan_spl.bin bin/yuan_spl_bootable.bin
...
dis: bin/yuan_spl_bootable.bin
	riscv64-linux-gnu-objdump -b binary -m riscv:rv64 -D bin/yuan_spl_bootable.bin

tools/mksunxiboot:
	${HOST_CC} -o tools/mksunxiboot mksunxiboot.c

burn: bin/yuan_spl_bootable.bin
	sudo dd if=bin/yuan_spl_bootable.bin of=${SDCARD} bs=512 seek=16 conv=sync
